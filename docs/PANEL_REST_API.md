...
**Роль в продукте:** бот и автоматизация ходят в API **master** для учёта клиентов и inbounds. **Пользовательский трафик** и выдаваемые пользователю **`vless://`** — с **нод**; общие правила — **[`VPN_OPERATING_MODEL.md`](VPN_OPERATING_MODEL.md)**.
